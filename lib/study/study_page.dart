            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  // Continue Learning
                  StreamBuilder<List<ContinueLearningModel>>(
                    stream: repository.getContinueLearning(),
                  ...
                  // Your Courses
                  StreamBuilder<List<StudyCourseModel>>(
                    stream: repository.getEnrolledCourses(),
                    builder: (context, snapshot) {
                      if (!snapshot.hasData || snapshot.data!.isEmpty) {
                         // Optional: Show prompt to browse store?
                  ...
                  // Daily Practice
                  StreamBuilder<List<DailyPracticeModel>>(
                    stream: repository.getDailyPractice(),
                    builder: (context, snapshot) {
                  ...
                  StreamBuilder<List<LiveClassModel>>(
                    stream: repository.getLiveClasses(),
                    builder: (context, snapshot) {
                      if (!snapshot.hasData || snapshot.data!.isEmpty) return const SizedBox.shrink();
                      return StudySection(
                  ...
                  StreamBuilder<List<TestModel>>(
                    stream: repository.getMockTests(),
                    builder: (context, snapshot) {
                      if (!snapshot.hasData || snapshot.data!.isEmpty) return const SizedBox.shrink();
                      return StudySection(
                        title: 'Mock Tests',
